...
/**
 * Variations Windows Look and Feel
 * This alternate look and feel currently supports an alternate slider appearance only,
 * through the VariationsWindowsSliderUI class. VariationsWindowsLookAndFeel is thus not designed
 * to be applied globally, but to the slider component only.
 *
 * @author Brent Yorgason
 */

public class VariationsWindowsLookAndFeel extends BasicLookAndFeel {
...
// color information -- maybe more than we need
  ...
  // constructor
  public VariationsWindowsLookAndFeel() {
    super();
  }
  ...
  public String getID() {
    return "VariationsWindowsLookAndFeel";
  }
  public String getName() {
    return "VariationsWindows Look and Feel";
  }
  public String getDescription() {
    return "The VariationsWindows Look and Feel";
  }
  protected void initClassDefaults(UIDefaults table) {
    super.initClassDefaults(table);
    table.put("SliderUI", "VariationsWindowsSliderUI");
 }
