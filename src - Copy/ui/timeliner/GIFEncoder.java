 ...
 * */
    public GIFEncoder(Image image, Component c) throws AWTException {
      // BTY: first, reduce the image to 256 colors
      try {
        ...
        image = (c.createImage(new MemoryImageSource(w, h, pix, 0, w)));
      }
      catch (Exception e) {
        JOptionPane.showMessageDialog(null, "Error creating GIF image.", "Error",
