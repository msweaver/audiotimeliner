...
/**
 * TimelineFilter
 * a file filter for timeline files
...
public class TimelineFilter extends FileFilter {
  ...
  private boolean useExtensionsInDescription = true;
     ...
     */
    public TimelineFilter(String extension) {
        this(extension,null);
    }
     ...
     */
    public TimelineFilter(String extension, String description) {
        this();
     ...
     */
    public TimelineFilter(String[] filters) {
        this(filters, null);
    }
     ...
     */
    public TimelineFilter(String[] filters, String description) {
        this();
