...
/**
 * VariationsMac Slider UI
 * This class implements an alternate user interface for a slider object that
 * uses the VariationsMacLookAndFeel.
 *
 * @author Brent Yorgason
 */

 public class VariationsMacSliderUI extends SliderUI {
   ...
   protected Color getShadowColor() {
    ...
    // ComponentUI Interface Implementation methods
     ...
     public static ComponentUI createUI(JComponent c)    {
        return new VariationsMacSliderUI((JSlider)c);
    }

    public VariationsMacSliderUI(JSlider c) {
    }
    ...
    public void installUI( JComponent c ) {
        ...
        leftToRightCache = VariationsMacLookAndFeel.isLeftToRight(slider);
    ...
    protected void calculateTrackRect() {
        if ( slider.getOrientation() == JSlider.HORIZONTAL ) {
            ...
            if(VariationsMacLookAndFeel.isLeftToRight(slider)) {
    ...
    protected void recalculateIfOrientationChanged() {
        boolean ltr = VariationsMacLookAndFeel.isLeftToRight(slider);
    ...
    public void paintFocus(Graphics g)  {
        ...
        VariationsMacLookAndFeel.drawDashedRect( g, focusRect.x, focusRect.y,
